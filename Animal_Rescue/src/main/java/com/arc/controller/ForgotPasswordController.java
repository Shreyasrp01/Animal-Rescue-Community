...
import com.arc.services.ForgotPasswordService;
...
public class ForgotPasswordController {
    ...
    public ResponseEntity<?> verifyOTP(
        ...
        return ResponseEntity.ok(new ApiResponse("OTP Verified","Success"));
    }
    ...
    public ResponseEntity<?> changePassword(
        ...
        return ResponseEntity.ok(
                new ApiResponse("Password Changed Successfully","Success"));
    }
}
